...
| S5 | [`s5-pdf-engine-plan.md`](s5-pdf-engine-plan.md) | Decompose generator; isolate + bundled fonts + MultiPage | 🟡 In progress (branch `s5-pdf-engine`): ✅ offline fonts + ✅ MultiPage (verified); ⬜ DTO+isolate, decomposition, caching |
